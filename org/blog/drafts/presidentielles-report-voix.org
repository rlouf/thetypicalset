...
- Lorsqu'on le verra plus loin, les distributions marginales $P\left(Y_2 | X_1)$ sont très étalées. Or le modèle n'est pas probabiliste et ne retourne qu'une seule valeur; Un /modèle bayésien/ correctement calibré permettrait a priori de rendre compte de l'étalement de ces distributions;
