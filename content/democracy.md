...
The purpose of this notebook is to study the history of democracy with a focus on ancient Greece and the United States, and learn whatever lesson there is to learn, if any. The topic of democracy is paramount in politics, because it [[democracy_takes_precedence|takes precedence over almost every other concept]] in the sense that it can be used to justify many measures, such as [[progressive_taxes_are_justified_by_the_need_to_preserve_democracy|progressive taxation]].

Demcracy as a deliberation mechanism for [[collective_cognition|Collective Cognition]], and [[democracy_is_an_efficient_way_to_generate_good_ideas|an efficient way for generating good ideas.]]
...
Lasch in *[[the_revolt_of_the_elites_and_the_betrayal_of_democracy|The Revolt of the Elite]]* makes the case that democracy is the most educational form of government, and agrees with Hannah Arendt that it precedes equality: it is a way to reach equality.
...
- The Scholar Stage's [Pinning for Democracy: a few readings](https://scholars-stage.org/pining-for-democracy-a-few-readings/) for a list of readings on the American democracy.
- [Article](https://plato.stanford.edu/entries/democracy/) on the Stanford Encyclopedia of Philosophy
