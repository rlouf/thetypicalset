...
Revue du livre de Camille Landais, Emmauel Saez et Thomas Piketty (2010). Le contenu du livre est appuyé par un [simulateur](https://www.revolution-fiscale.fr/simulateur-complet) dont les données de bases et programmes sont disponibles en ligne. Il est possible de tester une implémentation de ce système fiscale avec [[openfisca|Openfisca]]: voir [l'implémentation dans le repo](https://github.com/openfisca/openfisca-france/blob/master/openfisca_france/reforms/landais_piketty_saez.py).
...
Voir la [justification des auteurs](https://www.revolution-fiscale.fr/le-systeme-actuel/des-impots-progressifs-/16-le-profil-actuel-des-differents-types-de-cotisations-sociales) (landais2011)
...
2.  Pôle Emploi dépense de façon disproportionnée plus pour les plus riches [les données ici](https://www.pole-emploi.org/opendata/les-demandeurs-demploi-indemnise.html?type=article)
...
**Conflit fiscal et politique se nourrit des incertitudes liées à la forme exacte de la pyramide des revenus.** Voir [l'annexe du livre](https://www.revolution-fiscale.fr/annexes-livre/Annexes(Livre).pdf) pour la façon dont les auteurs ont calculé cette distribution. C'est impossible à reproduire sans leurs données à un niveau micro. Peut-être à haut niveau en reprenant les données de l'INSEE par décile et en fittant une courve sur ces déciles.
...
**Source:** Mélange de plusieurs sources, voir [l'annexe du livre](https://www.revolution-fiscale.fr/annexes-livre/Annexes(Livre).pdf).
...
- *Famille:* Prestations familiales + quotient familial -> crédit d'impôt de 190 euros par enfant. Ce crédit est individualisé: chaque parent bénéficie de la moitié de ce crédit par défaut avec possibilité de changer ce calcul. Ne comprend pas le Complement Libre Choix d'Activite. (p.101).
  ...
  [Injustice du système de répartition par enfant](https://www.revolution-fiscale.fr/img/g3-1.png)
...
- Tous les citoyens sont des contribuables, pas des assistés. Le système de redistribution est complètement séparé de celui de l'impôt. Le salaire direct des bas revenus est augmenté; plus besoin de la Prime Pour l'Emploi dont le calcul est compliqué et le versement souvent tardif (plus d'un an après).
...
[Les gagnants et les perdants](http://www.revolution-fiscale.fr/faq#gagnants) sont à suivre: ce n'est pas parceque le taux effectif d'imposition est plus faible en moyenne pour ue classe de revenu qu'il évolue à la baisse pour tout le monde ! *Point de basculement* différent pour des situations différentes. Voir [la courbe du % de perdants et gagnants](http://www.revolution-fiscale.fr/img/gagnants_.pdf) avec leur réforme. Notamment surveiller les perdants dans le bas de la curve; peut être compensé en réduisant le taux à 1%.
