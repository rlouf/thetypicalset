...
There are several ways to create money, and one is through [[public_debt_public|sovereign debt]]. This is constrained by requirements on [[liquidity_reserves|Liquidity reserves]].

- Post 2008, Bale III forces banks to have a fixed ratio "High Quality Assets" in their reserves. See the [the document](https://www.bis.org/publ/bcbs238_fr.pdf)
- Here is the ECB's [implementation of their monetary policy](https://www.ecb.europa.eu/pub/pdf/other/gendoc2011en.pdf?c7c23fd7c60fb4477f32c5c922d60eb3)
...
To read on the ECB system: [Demand for central bank reserves and monetary policy implementation frameworks: the case of the Eurosystem](https://www.ecb.europa.eu/pub/pdf/scpops/ecb.op282~6017392312.en.pdf)X
