...
I've been working with [Alex Andorra](https://twitter.com/alex_andorra\\) on [Pollsposition](https://twitter.com/pollsposition) where we use [[bayesian_statistics|Bayesian statistics]] to analyze polls for french elections.
