...
aliases:
  - 86cc91ce-eb0d-4d42-ac5b-38f6bcbfe678
---
...
Let us consider a simple example, and imagine that my [[polya_gamma_augmentation|Polya-Gamma augmentation]] links to Amanda's "polya\\~gamma~" note and Elie's "gibbs\\~sampling~" note:

![[img/knowledge-links.svg]]

As the author I would like some kind of guarantees from my knowledge system.

# Protecting knowledge against deletion

**The problem** If Elie deletes "gibbs\\~sampling~" from the server where it was stored, the HTTP link becomes stale, this knowledge is inaccessible. Someone consulting my notes will never know what I was referring to; worse my note might loose context, and the meaning will be altered. As a matter of fact [[<https://en.wikipedia.org/wiki/Link_rot?utm_source=substack&utm_medium=email#>:\~:text=about%20one%20link%20out%20of%20every%20200%20broke%20each%20week ][1 in every 200 links die every week]].

**The cope** The fear of this happening leads people to write self-contained knowledge repositories. Great content gets copied when it could just get referenced[^1]. I have noticed, without being able to offer a quantitative proof of this (yet), that digital gardens are prone to this knowledge accretion phenomenon; they tend to be more self-contained as time goes, instead of being more connected to the outside.
...
- [Lots of Copies Keep Stuff Safe](https://www.lockss.org/about/frequently-asked-questions)
- "Link Rot" ([Wikipedia article](https://en.wikipedia.org/wiki/Link_rot?utm_source=substack&utm_medium=email#:~:text=about%20one%20link%20out%20of%20every%20200%20broke%20each%20week))
- The [Interplanetary File System](https://github.com/ipfs/ipfs) peer-to-peer protocol appears to be suited for this;
- [Noosphere](https://github.com/subconsciousnetwork/noosphere) is a work-in-progress protocol that articulates similar ideas in its design document.

[^1]: Content also gets copied because of the *discovery problem*: people just don't know that this content exists. In the same way that Google (partially) solved the discovery problem in an HTTP world, any new protocol will need one or several discovery apps.
