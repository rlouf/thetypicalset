...
aliases:
  - 19a28994-247b-40bf-8d9f-55b65edab3f1
---
...
In this case $Z$'s density has a closed-form expression; $Z_{rv}$ has a [trapezoidal distribution](https://en.wikipedia.org/wiki/Trapezoidal_distribution). So we should be able to replace this sum with this distribution directly.

[A list](https://en.wikipedia.org/wiki/List_of_convolutions_of_probability_distributions) of cases where the convolution of two or more random variables has a closed-form solutions, or rather is a known measure, is available on Wikipedia.
