...
aliases:
  - 8a51bcc1-fe81-4708-8b46-1f114e698066
---
...
\end{equation*}
```
Where $b: \mathbb{R}^d \times \left[0, T\right] \to \mathrm{R}^d$ and $\operatorname{B}$ is a Brownian motion ([[gaussian_noise_kernel|Ornstein-Uhlenbeck process]]). In practice we apply a time-rescaling to the noise process to apply less noise at small time (where we assume most information to reconstruct images is contained, and move quickly from reference distribution at large times?)
