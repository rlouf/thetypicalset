...
aliases:
  - 9944cedc-2e0a-40a7-a8db-4e6da04fef28
---

This [talk](https://www.youtube.com/watch?v=GXs9Pmp6IKQ) by Andrew Gordon Wilson (2019). [Other talk](https://www.youtube.com/watch?v=lhwk4ESlyMA&t=951s) by Andrew Gordon Wilson (2022).
...
More principled [[fast_geometric_ensembling|Fast Geometric Ensembling]]

[[stochastic_weight_averaging|Stochastic weight averaging]] allows to compute an approximation in weight space from which we can sample;
