...
See [[forecasting_elections_in_multiparty_systems_a_bayesian_approach_combining_polls_and_fundamentals|Forecasting elections in multiparty systems: a Bayesian approach combining polls and fundamentals]]
...
- We use the [[squared_exponential_kernel|Squared exponential kernel]] but the [[gaussian_noise_kernel|Ornstein-Uhlenbeck kernel]] should be more adaptated as a stochastic process. We could also try a non-stationary kernel as the [[wiener_kernel|Wiener kernel]] (I don't see why the distribution should be stationary here)
