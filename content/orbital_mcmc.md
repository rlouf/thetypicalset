...
[^1]: [[hmc|HMC]], for instance, augments the state-space with an additional variable (the *momentum*) and then integrates the Hamiltonian equations to generate a new proposal point.
