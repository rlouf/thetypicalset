...
It is however more interesting to look at this but adjusted by the % change of the [[consumer_price_index|Consumer Price Index]], because you should [[always_compare_yields_to_inflation|Always compare yields to inflation]].

- 1Mo US Treasuries: <https://fred.stlouisfed.org/graph/fredgraph.png?g=KFd4>

![[images/2022-01-11_11-25-31_fredgraph.png.png]]

This looks messed up though

![[images/2022-01-11_11-29-08_fredgraph.png.png]]

The same thing is happening to corporate bonds:

![[images/2022-01-11_11-38-12_fredgraph.png.png]]

It is clear that the same thing is [happening to corporate bonds](https://fred.stlouisfed.org/graph/?g=KFco) which could be explained by [[quantitative_easing|Quantitative Easing]].
